...
{
    /// <summary>
    /// Interaction logic for EasyProject.xaml
    /// </summary>
    public partial class EasyProject : Window
    {
        ...
        private void btnOpenRAM2_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (selectItem.ShowDialog() == true)
            {
                ...
                txtSelectedEasy.Text = selectItem.FileName;
                imageRam = selectItem.FileName;
            }
        }
        ...
        {
            int pFrom = output1.IndexOf(before) + before.Length;
            int pTo = output1.LastIndexOf(after);
            string outputAUX = output1.Substring(pFrom, pTo - pFrom);
            return outputAUX;
        }
